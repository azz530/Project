    ...
    >
      ...
      >
        ...
        <el-form-item label="年级" label-width="80px" prop="grade">
          <el-select v-model="addStdForm.grade">
        ...
        <el-form-item label="班级" label-width="80px" prop="classes">
          <el-select v-model="addStdForm.classes">
...
export default {
  data() {
    const validateStdID = (rule, value, callback) => {
      let reg = /^[+]{0,1}(\d+)$/g;
      if (value === "") {
    ...
    return {
      ...
      addStdFormRules: {
        student_id: [
          { required: true, validator: validateStdID, trigger: "blur" },
